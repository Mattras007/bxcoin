...
...
to: /path/to/bxcoin/depends/x86_64-unknown-openbsd
```

Then set `BDB_PREFIX`:

```bash
export BDB_PREFIX="/path/to/bxcoin/depends/x86_64-unknown-openbsd"
```

#### GUI Dependencies
###### Qt5

Bxcoin Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
...
(see issue [#6658](https://github.com/bxcoin/bxcoin/issues/6658)).
