Bxcoin Core version 0.13.2 is now available from:

  <https://bxcoin.org/bin/bxcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bxcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bxcoin-tx to create v2 transactions (btcdrak)
