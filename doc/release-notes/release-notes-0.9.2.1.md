Bxcoin Core version 0.9.2.1 is now available from:

  https://bxcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BX to 0.01 BX
...
- Fix "Start bxcoin on system login"
