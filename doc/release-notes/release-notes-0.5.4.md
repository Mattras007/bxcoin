Bxcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bxcoin/files/Bxcoin/bxcoin-0.5.4/
...
http://gitorious.org/bxcoin/bitcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bxcoin-Qt notifications under Growl 1.3.
Increase required age of Bxcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Bxcoin-Qt over it. (Windows)
