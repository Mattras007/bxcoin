...
Bxcoin Core version 0.21.1 is now available from:

  <https://bitcoincore.org/bin/bxcoin-core-0.21.1/>
...
The addition of taproot-related features to Bxcoin Core's wallet is
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/bxcoin/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/bxcoin/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/bxcoin/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Bxcoin](https://bitcoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-bxcoin)
  - [What do Schnorr Signatures Mean for Bxcoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-bxcoin)
...
- Other
  - [Questions and answers related to taproot](https://bxcoin.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/bxcoin/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/bxcoin/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to bxcoin.conf documentation (jonatack)
