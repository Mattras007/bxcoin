Bxcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bxcoin/files/Bxcoin/bxcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bxcoin
...
New/changed settings (command-line or bxcoin.conf file)
--------------------------------------------------------
