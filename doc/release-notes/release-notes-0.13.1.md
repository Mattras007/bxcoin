Bxcoin Core version 0.13.1 is now available from:

  <https://bxcoin.org/bin/bxcoin-core-0.13.1/>
...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming Bxcoin wallet
  software more difficult and which seriously complicates the design of smart
  contracts for Bxcoin.
...
- **Weighting data based on how it affects node performance:** Some parts of
  each Bxcoin block need to be stored by nodes in order to validate future
...
- **Increased security for multisig:** Bxcoin addresses (both P2PKH addresses
  ...
  believed to be provided by Bxcoin's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  Bxcoin paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of Bxcoin's current ledger (called the UTXO set),
  ...
  note that Bxcoin Core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Bxcoin users to individually opt-in to almost any change in the Bxcoin
  Script language when those users receive new transactions.  Features
  currently being researched by Bxcoin Core contributors that may use this
  capability include support for Schnorr signatures, which can improve the
  privacy and efficiency of multisig transactions (or transactions with
  multiple inputs), and Merklized Abstract Syntax Trees (MAST), which can
  improve the privacy and efficiency of scripts with two or more conditions.
  Other Bxcoin community members are studying several other improvements
...
[BIP141]: https://github.com/bxcoin/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/bxcoin/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/bxcoin/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/bxcoin/bips/blob/master/bip-0145.mediawiki
...
Since Bxcoin Core 0.10.0, nodes have defaulted to only relaying and
...
[BIP147]: https://github.com/bxcoin/bips/blob/master/bip-0147.mediawiki
...
- #8829 `2a8bca4` Add bxcoin-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` bxcoin-util-test.py should fail if the output file is empty (jnewbery)
...
- #8683 `8a7d7ff` Fix incorrect file name bxcoin.qrc  (bitcoinsSG)
...
- #8817 `bcf3806` update bxcoin-tx to output witness data (jnewbery)
