Bxcoin Core version 0.9.4 is now available from:

  https://bxcoin.org/bin/0.9.4/
...
this update is incompatible with the Bxcoin system and could lead to consensus
forks.

Bxcoin Core released binaries from https://bxcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bxcoin/+archive/ubuntu/bxcoin
- A third-party or self-compiled Bxcoin Core

upgrade to Bxcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
