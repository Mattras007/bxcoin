Bxcoin Core version 0.10.4 is now available from:

  <https://bxcoin.org/bin/bxcoin-core-0.10.4/>
...
- #6953 `43c2789` Split bxcoin-tx into its own package
- #6953 `dfe0d4d` Include bxcoin-tx binary on Debian/Ubuntu
