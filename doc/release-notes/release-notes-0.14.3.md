Bxcoin Core version *0.14.3* is now available from:

  <https://bxcoin.org/bin/bxcoin-core-0.14.3/>
...
Bxcoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
