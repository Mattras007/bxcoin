...
Bxcoin Core version 0.19.1 is now available from:

  <https://bitcoincore.org/bin/bxcoin-core-0.19.1/>
...
From Bxcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bxcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bxcoin Core does not yet change appearance when
