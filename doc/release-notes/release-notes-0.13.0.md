Bxcoin Core version 0.13.0 is now available from:

  <https://bxcoin.org/bin/bxcoin-core-0.13.0/>
...
updates will be released anymore. Without security updates, using a bxcoin
wallet on a XP machine is irresponsible at least.

In addition to that, with 0.12.x there have been varied reports of Bxcoin Core
randomly crashing on Windows XP. It is [not clear](https://github.com/bxcoin/bxcoin/issues/7681#issuecomment-217439891)
...
- Adding `dbcache=100` in bxcoin.conf
...
For example:
    ...
    $ src/bxcoin-cli -stdin walletpassphrase
    mysecretcode
    120
...
Various code modernizations have been done. The Bxcoin Core code base has
...
- `bxcoin-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries targeting
  the 32-bit ARMv7-A architecture.
- `bxcoin-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries targeting
...
compatible peers.
[BIP 152](https://github.com/bxcoin/bips/blob/master/bip-0152.mediawiki)
...
HD wallets are incompatible with older versions of Bxcoin Core.

[Pull request](https://github.com/bxcoin/bxcoin/pull/8035/files), [BIP 32](https://github.com/bxcoin/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/bxcoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/bxcoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/bxcoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/bxcoin/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of Bxcoin Core is expected that
...
Witness)] (https://github.com/bxcoin/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/bxcoin/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
The two phases are distinct in the Bxcoin-Qt GUI. During the first one,
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/bxcoin/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/bxcoin/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/bxcoin/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/bxcoin/bxcoin/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for bxcoin-cli (laanwj)
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use BX/kB (MarcoFalke)
...
- #7613 `3798e5d` Add autocomplete to bxcoin-qt's console window (GamerSg)
...
- #8164 `0f24eaf` [Bxcoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7975 `fc23fee` Update bxcoin-core GitHub links (MarcoFalke)
