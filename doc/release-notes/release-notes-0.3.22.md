Download URL: https://sourceforge.net/projects/bxcoin/files/Bxcoin/bxcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BX fee schedule (users still pay 0.01 BX per kb, until next version)
