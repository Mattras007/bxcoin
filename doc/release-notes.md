Bxcoin Core version 27.0 is now available from:

  <https://bitcoincore.org/bin/bxcoin-core-27.0/>
...
using the Linux Kernel 3.17+, macOS 11.0+, and Windows 7 and newer. Bxcoin
...
- A C++20 capable compiler is now required to build Bxcoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Bxcoin Core would
