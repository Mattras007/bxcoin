...
This document provides guidelines for internationalization of the Bxcoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Bxcoin network</source>
        <translation>
            <numerusform>%n active connection to Bxcoin network</numerusform>
            <numerusform>%n active connections to Bxcoin network</numerusform>
        </translation>
    </message>
