...
By default, Bxcoin Core allows up to 125 connections to different peers, 11 of
...
limits are tiny. Keep in mind that bxcoin's trustless model works best if you are
