// Copyright (c) 2023 The Bxcoin Core developers
...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // bxcoin.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/bxcoin/bxcoin/issues/16220 about ways to
        ...
        // Show an error or warning if there is a bxcoin.conf file in the
