...
{
    // Test regression https://github.com/bxcoin/bxcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bxcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bxcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Bxcoin/Bxcoin-Qt.conf and all else left as default,
    // bxcoin-qt should set both -listen and -listenonion to false and start successfully.
