// Copyright (c) 2011-2021 The Bxcoin Core developers
...
{
    switch (unit) {
    case Unit::BX: return QString("BX");
...
{
    switch (unit) {
    case Unit::BX: return longName(unit);
...
{
    switch (unit) {
    case Unit::BX: return QString("Bitcoins");
...
{
    switch (unit) {
    case Unit::BX: return 100'000'000;
