...
Tracing (USDT) support for Bxcoin Core on Linux using. For more information on
USDT support in Bxcoin Core see the [USDT documentation].
...
[Bxcoin Core USDT documentation] on how to list available tracepoints in your
`bitcoind` binary.

[Bxcoin Core USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
Bxcoin P2P messages can be larger than 32kb (e.g. `tx`, `block`, ...). The
...
In a different terminal, starting Bxcoin Core in SigNet mode and with
re-indexing enabled.
